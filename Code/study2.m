...
figure;
subplot(5,1,1);
plot(t_w, w_re, 'b'); axis tight; ylim([0,3]);
title('Rectangular Window');
xlabel('k');
ylabel('A');
subplot(5,1,2);
plot(t_w, w_tr, 'c'); axis tight; ylim([0,3]);
title('Triangular Window');
xlabel('k');
ylabel('A');
subplot(5,1,3);
plot(t_w, w_ha, 'g'); axis tight; ylim([0,3]);
title('Hamming Window');
xlabel('k');
ylabel('A');
subplot(5,1,4);
plot(t_w, w_ba, 'y'); axis tight; ylim([0,3]);
title('Bartlett Window');
xlabel('k');
ylabel('A');
subplot(5,1,5);
plot(t_w, w_bl, 'm'); axis tight; ylim([0,3]);
